...
nombre_archivo = 'producción_{}_modulo_{}.csv'.format(STRING_LENGHT*STRING_COUNT, inicio)
...
for i in range(1, 7):
    # Falta este archivo, no está en colab
  df = pd.read_csv(f'ShellyEM3_week_{i}.csv')
  columna = df['Values']
...
for i in range(9, 19):
  ...
  valor =  pd.read_csv(f'2023-10-{str(i).zfill(2)}.csv')
...
df_prod_dia_8 = pd.read_csv(f'producción_8_modulo_{inicio}.csv')
...
df_prod_dia_1 = pd.read_csv(f'producción_1_modulo_{inicio}.csv')
...
demanda_dia = pd.read_csv(f'Datos_demanda/{dia}.csv')
...
archivo_csv = f'2023-10-09_shelly.csv'
...
nombre_archivo = 'Resultados/Datos_mensuales_caso_1.csv'
...
nombre_archivo = 'Resultados/Datos_mensuales_caso_2.csv'
...
nombre_archivo = 'Resultados/Datos_mensuales_caso_3.csv'
...
nombre_archivo = 'Resultados/Datos_mensuales_caso_4.csv'
...
nombre_archivo = 'Resultados/Datos_mensuales_caso_5.csv'
...
archivos_csv = ['Resultados/Datos_mensuales_caso_1.csv',
                'Resultados/Datos_mensuales_caso_2.csv',
                'Resultados/Datos_mensuales_caso_3.csv',
                'Resultados/Datos_mensuales_caso_4.csv',
                'Resultados/Datos_mensuales_caso_5.csv']
...
resultado.to_csv(f'Resultados/Casos_para_dia_{inicio}.csv', index=False)
...
archivo_excel = 'Datos_de_produccion.xlsx'


df_produccion = pd.read_excel(archivo_excel)

produccion_txt = 'datos_produccion.dat'
...
df1 = pd.read_csv('datos_produccion.dat', header=None, names=encabezado1)
df2 = pd.read_csv('datos.dat', header=None, names=encabezado2)
...
demanda_dia = pd.read_csv(f'Datos_demanda/2023-10-10.csv')
list_demanda_dia =demanda_dia['Demanda'].values.tolist()
